...
static long long scanexp(FILE_IMPL *f, int pok)
{
	int c;
	int x;
	long long y;
...
static long double decfloat(FILE_IMPL *f, int c, int bits, int emin, int sign, int pok)
{
	uint32_t x[KMAX];
...
static long double hexfloat(FILE_IMPL *f, int bits, int emin, int sign, int pok)
{
	uint32_t x = 0;
	long double y = 0;
	long double scale = 1;
...
long double __floatscan(FILE_IMPL *f, int prec, int pok)
{
	int sign = 1;
	size_t i;
	int bits;
