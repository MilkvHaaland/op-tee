...
/* FCE related */
TEE_Result _utee_fce_open(void **fce_handle);
TEE_Result _utee_fce_close(void *fce_handle);
TEE_Result _utee_fce_query_result_cnt(void *fce_handle, unsigned int *cnt);
TEE_Result _utee_fce_set_result_cnt(void *fce_handle, unsigned int *cnt);
TEE_Result _utee_fce_set_attr(void *fce_handle, struct fce_cfg *cfg);
TEE_Result _utee_fce_get_attr(void *fce_handle, struct fce_cfg *cfg);
TEE_Result _utee_fce_do_compare(void *fce_handle, struct target_vector *target_vect);
TEE_Result _utee_fce_get_result(void *fce_handle, struct top_result *top_buf);
TEE_Result _utee_fce_suspend(void *fce_handle);
TEE_Result _utee_fce_resume(void *fce_handle);
TEE_Result _utee_fce_stop(void *fce_handle);
TEE_Result _utee_fce_create_featurelib(void *fce_handle, unsigned int size, void **buf);
TEE_Result _utee_fce_release_featurelib(void *fce_handle, void* buf);
TEE_Result _utee_fce_set_featurelib(void *fce_handle, struct fce_lib_buf_info *info);
TEE_Result _utee_fce_config_init(struct fce_cfg *cfg);
TEE_Result _utee_fce_check_result(struct top_result *res1, struct top_result *res2);
/* End of FCE related */
